// =============================================================================
// hc_transfer_legacy.sqf - Legacy custom Headless Client AI transfer
//
// This is the previous manual setGroupOwner load balancer, kept as a fallback.
// Do not run this script while ACE Headless is enabled, because both systems
// would try to control AI group ownership.
//
// To use this legacy script intentionally, call it from initServer.sqf:
